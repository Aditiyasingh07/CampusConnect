...
function Signup() {
  ...
  return (
    <>
     <div> 
      <div className=" fixed md:top-5 top-0 z-50 menu-glass-card md:left-15 left-[-25px] rounded-full md:mt-0 mt-5 md:ml-0 ml-10">
        <div className="flex justify-center items-center bg-white md:h-20 md:w-20 h-[70px] w-[70px] rounded-full">
      ...
      <div className="relative">
        {!isOpen && (
          <button
            className="fixed md:top-5 top-0 z-50 menu-glass-card md:right-15 right-[-25px] text-white md:px-5 px-0 md:py-4 py-0 rounded-full shadow-lg
            md:mt-0 mt-5 md:mr-0 mr-10 md:h-20 md:w-20 h-[70px] w-[70px] flex items-center justify-center"
            onClick={() => setIsOpen(true)}
          >
            <img className="md:w-[40px] w-[40px]" src={menu}></img>
          </button>
        )}
        ...
        >
          ...
          <div className="md:flex gap-5 md:flex-col text-center justify-center items-center text-white md:text-3xl text-[1.7rem] md:mt-0 mt-15 md:mb-0 mb-[-50px]">
            ...
            <Link to="/memories" className="hover:text-gray-200 cursor-pointer">
              . MEMORIES
            </Link>
    ...
    <div className="flex p-6 h-screen signup md:pt-[200px] pt-[150px]">
      ...
      <h1 className="md:text-2xl text-[1.7rem] font-bold mb:mb-0 mb-5">Campus Connect Signup</h1>
      <form
        onSubmit={(e) => {
          e.preventDefault();
          handleSignup();
