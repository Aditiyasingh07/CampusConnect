...
const EventCard = () => {
    ...
    return (
      <header className=" flex flex-col gap-y-7 items-center text-center p-4 md:w-[550px] w-[1250px] md:h-[350px] h-[120%]">
        <div>
        ...
        <div className="space-y-3">
          ...
          <div className="w-full mt-15 bg-gradient-to-r from-blue-600 via-red-400 to-pink-800 p-4 md:text-2xl text-[3rem] hover:bg-blue-700 rounded-3xl font-bold text-white">Register Now</div>
        </div>
      </header>
    );
  };
