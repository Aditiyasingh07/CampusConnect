  ...
  return (
    <>
      ...
      <div className=" flex flex-col justify-center md:bg-transparent md:h-full h-[1180px] bg-black items-center md:pt-0 pt-0">
        <img
          className="w-full md:h-[742px] h-full md:flex hidden"
          src={cricbg}
        ></img>
        <div className=" absolute z-30 md:h-full h-[1300px] w-full bg-black opacity-100"></div>
        <div className=" absolute z-40 flex md:w-[60%] w-full flex-wrap justify-center mt-35 items-center gap-5">
