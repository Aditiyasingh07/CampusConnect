    ...
    <>
      <div className="w-full h-screen flex flex-col justify-center items-center pb-40">
        ...
        <div className=" flex flex-wrap justify-center gap-15 w-full h-full items-center px-50">
          <div className=" memo flex flex-col justify-center items-center md:h-60 h-[500px] md:w-[30%] w-[90%] text-black font-bold rounded-4xl">
          ...
          <div className=" memo memo1 flex flex-col justify-center items-center md:h-60 h-[500px] md:w-[30%] w-[90%] text-black font-bold rounded-4xl ">
          ...
          <div className=" memo memo2 flex flex-col justify-center items-center md:h-60 h-[500px] md:w-[30%] w-[90%] text-black font-bold rounded-4xl">
          ...
          <div className=" memo memo3 flex flex-col justify-center items-center md:h-60 h-[500px] md:w-[30%] w-[90%] text-black font-bold rounded-4xl ">
            <Link to="/all">
