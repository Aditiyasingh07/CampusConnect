    ...
    <>
      <div className="w-full h-screen m-auto md:mt-0 mt-450 bg-[#f5f5f5]">
        ...
        <div className=" flex flex-wrap md:w-[60%] w-full m-auto gap-10 md:px-20 px-0 text-center justify-center">
          ...
          {/* <div className="flex flex-col p-5 rounded-3xl justify-center items-center bg-[#119CFDFF] w-1/3 md:h-[300px] h-[400px]">
            <img
              className="rounded-full"
              src={relogo}
              width="100px"
            ></img>
            <h1 className=" md:text-[16px] text-[3rem] font-bold text-white mb-3">
              Rahul Singh
            </h1>
            <p className=" text-white md:text-sm text-[2rem] md:p-0 p-10">
              this is my world and i own this world.this is my world and i own
              this world.
            </p>
          </div> */}
          ...
          {/* <div className="flex flex-col p-5 rounded-3xl justify-center items-center bg-[#119CFDFF] w-1/2 md:h-[300px] h-[400px]">
            <img
              className="rounded-full"
              src={relogo}
              width="100px"
